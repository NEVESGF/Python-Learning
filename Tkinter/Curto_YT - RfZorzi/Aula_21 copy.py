...
class Application(Funcs,Relatorios): 
    ...
    def tela_login(self):
        ...
        self.root1.geometry("300x350") #define o tamanho de inicio da janela horizontal x vertical
    ...
    def telaprincipal(self):
            ...
            ### FAZER FUNCIONAR
            #self.root.protocol('WM_CLOSE_WINDOW',print("teste1233321"))
    ...
    def widgets_login(self):
            ...
            #Labels
            Label(root1,text="Usuário:").place(relx=0.17,rely=0.75,width=60,relheight=0.09)
            Label(root1,text="Senha  :").place(relx=0.17,rely=0.88,width=60,relheight=0.09)
    ...
    def tela(self):
        ...
        #self.root.protocol("WM_DELETE_WINDOW", closewindows)
